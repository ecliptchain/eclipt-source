...
These are the dependencies currently used by Eclipt. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/ecliptnl
Keybase  - https://keybase.io/team/eclipt/
