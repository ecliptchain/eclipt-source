...
Add these lines to your `/etc/tor/torrc` (or equivalent config file):
    ...
    HiddenServicePort 22754 127.0.0.1:22753

The directory can be different of course, but virtual port numbers should be equal to
your bitcoind's P2P listen port (22754 by default), and target addresses and ports
should be equal to binding address and port for inbound Tor connections (127.0.0.1:22753 by default).
...
and open port 22754 on your firewall (or use port mapping, i.e., `-upnp`).
