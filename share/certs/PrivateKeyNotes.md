...
unlocked to sign the Eclipt-Qt.app bundle.
...
allowing somebody to distribute a Eclipt-Qt.app or eclipt-qt-setup.exe with a valid
...
that the eclipt-qt.exe file inside the installer had not been tampered with.
