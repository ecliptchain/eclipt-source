...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s eclipt-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  eclipt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eclipt transaction") + "\n" +
              "  eclipt-tx [options] -create [commands]   " + _("Create hex-encoded eclipt transaction") + "\n" +
              "\n";
