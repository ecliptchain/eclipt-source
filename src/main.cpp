...
#if defined(NDEBUG)
# error "Eclipt cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Eclipt Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Eclipt also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Eclipt also requires low S in sigs
