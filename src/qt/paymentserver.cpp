...
const QString BITCOIN_IPC_PREFIX("eclipt:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/eclipt-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/eclipt-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/eclipt-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click eclipt: links
...
//
// OSX-specific way of handling eclipt: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in eclipt: URIs
